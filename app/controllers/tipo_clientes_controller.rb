  ...
  def create
    ...
    respond_to do |format|
      if @tipo_cliente.save
        format.html { redirect_to tipo_cliente_url(@tipo_cliente), notice: "Tipo cliente was successfully created." }
  ...
  def update
    respond_to do |format|
      if @tipo_cliente.update(tipo_cliente_params)
        format.html { redirect_to tipo_cliente_url(@tipo_cliente), notice: "Tipo cliente was successfully updated." }
